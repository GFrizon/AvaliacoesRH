            ...
            @forelse ($grupos as $grupo)
                <tr>
                    <td class="px-4 py-5 align-top">
                        ...
                        <span class="status-pill status-info mt-3">{{ $grupo['avaliacoes']->count() }} ciclo{{ $grupo['avaliacoes']->count() === 1 ? '' : 's' }}</span>
                    </td>
                    <td class="px-4 py-5 align-top table-text">{{ $grupo['gestor']->name }}</td>
                    <td class="px-4 py-5 align-top table-text">
    ...
    @forelse ($grupos as $grupo)
        <article class="mobile-card p-4">
            <div class="flex items-start justify-between gap-3">
                ...
                <span class="status-pill status-info shrink-0">{{ $grupo['avaliacoes']->count() }} ciclo{{ $grupo['avaliacoes']->count() === 1 ? '' : 's' }}</span>
            </div>
